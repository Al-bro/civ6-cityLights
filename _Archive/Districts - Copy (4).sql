...
(	'BUILDING_COREX_NATIONAL_FOOD',										'KIND_BUILDING'			),
...
(	'PROJECT_COREX_IMMIGRATION',										'KIND_PROJECT'			);
...
--===========================================================================================================================================================================--
	...
	/* NATIONAL */								                                                                                                                                                                                                                                                                                                                
			...
			(	'BUILDING_COREX_NATIONAL_FAI',		'LOC_BUILDING_COREX_NATIONAL_FAI_NAME',				NULL,						'CIVIC_REFORMED_CHURCH',		'725',			'1',					'DISTRICT_COREEXPANSIONA', 		'LOC_BUILDING_COREX_NATIONAL_FAI_DESCRIPTION',		'4',			'0',						'NO_ERA',				'ADVISOR_RELIGIOUS'			),
			(	'BUILDING_COREX_NATIONAL_FOOD',		'LOC_BUILDING_COREX_NATIONAL_FOOD_NAME',			'TECH_REPLACEABLE_PARTS',	NULL,							'725',			'1',					'DISTRICT_COREEXPANSIONB', 		'LOC_BUILDING_COREX_NATIONAL_FOOD_DESCRIPTION',		'6',			'0',						'NO_ERA',				'ADVISOR_GENERIC'			),
			(	'BUILDING_COREX_NATIONAL_GOL',		'LOC_BUILDING_COREX_NATIONAL_GOL_NAME',				'TECH_ECONOMICS',			NULL,							'725',			'1',					'DISTRICT_COMMERCIAL_HUB', 		'LOC_BUILDING_COREX_NATIONAL_GOL_DESCRIPTION',		'6',			'0',						'NO_ERA',				'ADVISOR_GENERIC'			),
			(	'BUILDING_COREX_NATIONAL_CUL',		'LOC_BUILDING_COREX_NATIONAL_CUL_NAME',				NULL,						'CIVIC_CULTURAL_HERITAGE',		'725',			'1',					'DISTRICT_THEATER', 			'LOC_BUILDING_COREX_NATIONAL_CUL_DESCRIPTION',		'8',			'0',						'NO_ERA',				'ADVISOR_CULTURE'			),
			(	'BUILDING_COREX_NATIONAL_SCI',		'LOC_BUILDING_COREX_NATIONAL_SCI_NAME',				NULL,						'CIVIC_SPACE_RACE',				'725',			'1',					'DISTRICT_SPACEPORT', 			'LOC_BUILDING_COREX_NATIONAL_SCI_DESCRIPTION',		'8',			'0',						'NO_ERA',				'ADVISOR_TECHNOLOGY'		);                                                                                                                                                                                                                                                                                                                                                               		
	...
	/* DISTRICT A */			
			...
			(	'BUILDING_COREXA_TIER2_FAI',		'YIELD_FAITH',			'2'				),
			(	'BUILDING_COREXA_TIER2_FAI',		'YIELD_GOLD',			'2'				),
		
	/* DISTRICT B */

			(	'BUILDING_COREXB_TIER1_SCI',		'YIELD_SCIENCE',		'2'				),			
			(	'BUILDING_COREXB_TIER1_CUL',		'YIELD_CULTURE',		'1'				),
			...
			(	'BUILDING_COREXB_TIER2_SCI',		'YIELD_FAITH',			'1'				),
			(	'BUILDING_COREXB_TIER2_SCI',		'YIELD_SCIENCE',		'2'				),			
			(	'BUILDING_COREXB_TIER2_CUL',		'YIELD_PRODUCTION',		'1'				),
			(	'BUILDING_COREXB_TIER2_CUL',		'YIELD_CULTURE',		'2'				),
			(	'BUILDING_COREXB_TIER2_GOL',		'YIELD_PRODUCTION',		'2'				),
			(	'BUILDING_COREXB_TIER2_GOL',		'YIELD_GOLD',			'2'				),			

	/* DISTRICT C */

			(	'BUILDING_COREXC_TIER1_SCI',		'YIELD_SCIENCE',		'2'				),
			(	'BUILDING_COREXC_TIER1_SCI',		'YIELD_CULTURE',		'1'				),			
			(	'BUILDING_COREXC_TIER1_CUL',		'YIELD_CULTURE',		'2'				),
			(	'BUILDING_COREXC_TIER1_CUL',		'YIELD_GOLD',			'2'				),
			(	'BUILDING_COREXC_TIER1_GOL',		'YIELD_GOLD',			'4'				),			
			(	'BUILDING_COREXC_TIER1_GOL',		'YIELD_PRODUCTION',		'1'				),			
	
			(	'BUILDING_COREXC_TIER2_SCI',		'YIELD_SCIENCE',		'1'				),
			...
			(	'BUILDING_COREXC_TIER2_GOL',		'YIELD_GOLD',			'8'				);			
	...
	/* BUILDING C */	
		...
		/* TIER 2 */
			...
			(	'BUILDING_COREXC_TIER2_GOL',				'BUILDING_COREXC_TIER2_GOL_COREXA_ADJACENCY_YIELD'			),
			(	'BUILDING_COREXC_TIER2_GOL',				'BUILDING_COREXC_TIER2_GOL_COREXB_ADJACENCY_YIELD'			),
			(	'BUILDING_COREXC_TIER2_GOL',				'BUILDING_COREXC_TIER2_GOL_COREXC_ADJACENCY_YIELD'			),
...
--===========================================================================================================================================================================--
		...
		INSERT INTO DynamicModifiers 
			...
			(	'MODIFIER_COREX_SINGLE_CITY_ADJUST_DIS_PROD',									'COLLECTION_OWNER',					'EFFECT_ADJUST_CITY_PRODUCTION_DISTRICT'															),			
	...
	/* BUILDING C */
		...
		INSERT INTO Modifiers 
			(	ModifierId,												ModifierType,									 				RunOnce,	Permanent,	OwnerRequirementSetId,		SubjectStackLimit,			SubjectRequirementSetId							)	VALUES
		
	/* CORE EXPANSION */			
		
			(	'CORXA_PLOT_MINE_PROD_1_YIELD',							'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,						'COREXA_SET_PLOT_HAS_MINE'						),
			(	'CORXA_PLOT_FARM_FOOD_1_YIELD',							'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_FARM'						),
			(	'CORXA_PLOT_QUARRY_PROD_1_YIELD',						'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_QUARRY'					),
			(	'CORXA_PLOT_QUARRY_GOLD_1_YIELD',						'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_QUARRY'					),
			(	'CORXA_PLOT_PLANTATION_GOLD_2_YIELD',					'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_PLANTATION'				),
			(	'CORXA_PLOT_PLANTATION_FOOD_1_YIELD',					'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_PLANTATION'				),
			(	'CORXA_PLOT_CAMP_GOLD_2_YIELD',							'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_CAMP'						),	
			(	'CORXA_PLOT_PASTURE_PROD_1_YIELD',						'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_PASTURE'					),
			(	'CORXA_PLOT_FISHING_FOOD_1_YIELD',						'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_FISHING'					),
			(	'CORXA_PLOT_FISHERY_FOOD_1_YIELD',						'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_FISHERY'					),
			(	'CORXA_PLOT_LUMBER_MILL_PROD_1_YIELD',					'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_LUMBER_MILL'				),
			(	'CORXA_PLOT_PASTURE_FOOD_1_YIELD',						'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXA_SET_PLOT_HAS_PASTURE'					),						
										                                                                                                                                                    
			(	'CORXA_GOLD_PER_POPULATION',							'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_PER_POPULATION',		 0,			0,			NULL,						NULL,							NULL											),
										                                                                                                                                                    
			(	'CORXA_CITY_INNER_DEFENSE',								'MODIFIER_PLAYER_CITIES_ADJUST_INNER_DEFENSE',					 0,			0,			NULL,						NULL,							NULL											),
			(	'CORXA_CITY_INNER_DEFENSE_2',							'MODIFIER_PLAYER_CITIES_ADJUST_INNER_DEFENSE',					 0,			0,			NULL,						NULL,							NULL											),
			(	'CORXA_CITY_INNER_DEFENSE_3',							'MODIFIER_PLAYER_CITIES_ADJUST_INNER_DEFENSE',					 0,			0,			NULL,						NULL,							NULL											),			
										                                                                                                                                                    
			(	'CORXA_CITY_PROD_MILITARY',								'MODIFIER_GOVERNOR_ADJUST_CITY_MILITARY_UNIT_PRODUCTION',		 0,			0,			NULL,						NULL,							NULL											),
			(	'CORXA_CITY_PROD_MILITARY_2',							'MODIFIER_GOVERNOR_ADJUST_CITY_MILITARY_UNIT_PRODUCTION',		 0,			0,			NULL,						NULL,							NULL											),
			(	'CORXA_CITY_PROD_MILITARY_3',							'MODIFIER_GOVERNOR_ADJUST_CITY_MILITARY_UNIT_PRODUCTION',		 0,			0,			NULL,						NULL,							NULL											),			
										                                                                                                                                                    
	/* BUILDING A */										                                                                                                                                
											                                                                                                                                                
		/* TIER 1 */										                                                                                                                                
										                                                                                                                                                    
			(	'BUILDING_COREXA_TIER1_SCI_GREATWORK_YIELD',			'BUILDING_COREX_SINGLE_CITY_ADJUST_GREATWORK_YIELD',			 0,			0,			NULL,						NULL,							NULL											),		
										                                                                                                                                                    
			(	'BUILDING_COREXA_TIER1_CUL_SLOT',						'MODIFIER_SINGLE_CITY_ADJUST_EXTRA_GREAT_WORK_SLOTS',			 1,			1,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER1_CUL_LIBRARY_CUL',				'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER1_CUL_WRITER_PPT',					'MODIFIER_SINGLE_CITY_DISTRICTS_ADJUST_GREAT_PERSON_POINTS',	 0,			0,			NULL,						NULL,							'DISTRICT_IS_THEATER'							),
										                                                                                                                                                    
		/* TIER 2 */										                                                                                                                                
										                                                                                                                                                    
			(	'BUILDING_COREXA_TIER2_CUL_PROJECT',					'MODIFIER_SINGLE_CITY_ADJUST_PROJECT_PRODUCTION',				 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_CUL_PUB_PROJECT',				'MODIFIER_SINGLE_CITY_ADJUST_PROJECT_PRODUCTION',				 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_SCI_PROJECT',					'MODIFIER_SINGLE_CITY_ADJUST_PROJECT_PRODUCTION',				 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_FAI_PROJECT',					'MODIFIER_SINGLE_CITY_ADJUST_PROJECT_PRODUCTION',				 0,			0,			NULL,						NULL,							NULL											),
											                                                                                                                                                
			(	'BUILDING_COREXA_TIER2_CUL_BUILDING_MODIFIER',			'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_MODIFIER',	 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_SCI_BUILDING_MODIFIER',			'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_MODIFIER',	 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_FAI_BUILDING_MODIFIER',			'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_MODIFIER',	 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_CUL_BUILDING_MODIFIER_ALT',		'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_MODIFIER',	 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_SCI_BUILDING_MODIFIER_ALT',		'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_MODIFIER',	 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_FAI_BUILDING_MODIFIER_ALT',		'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_MODIFIER',	 0,			0,			NULL,						NULL,							NULL											),
										                                                                                                                                                    
	/* BUILDING B */										                                                                                                                                
										                                                                                                                                                    
		/* TIER 1 */										                                                                                                                                
												                                                                                                                                            
			(	'PROJECT_COREXB_TIER1_CUL_PUBLISHERS',					'MODIFIER_PLAYER_GRANT_YIELD_BASED_ON_CURRENT_YIELD_RATE',		 1,			1,			NULL,						NULL,							NULL											),
										                                                                                                                                                    
			(	'BUILDING_COREXB_TIER1_SCI_GREATPERSON_YIELD',			'MODIFIER_PLAYER_ADJUST_YIELD_MODIFIER_PER_EARNED_GREAT_PERSON', 0,			0,			NULL,						NULL,							'COREXB_SET_CAMPUS_HIGH_ADJACENCY'				),		
										                                                                                                                                                    
			(	'BUILDING_COREXB_TIER1_GOL_EXTRA_TRD_ROUTE',			'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_CAPACITY',			   		 0,			0,			NULL,						NULL,							'BUILDING_IS_SHIPYARD'							),
			(	'BUILDING_COREXB_TIER1_GOL_TRD_TOURE_YIELD_PRE_LUX',	'MODIFIER_COREX_SINGLE_CITY_ADJUST_TRADE_ROUTE_YIELD_PER_LUX',	 0,			0,			NULL,						NULL,							'BUILDING_IS_SHIPYARD'							),
												                                                                                                                                            
		/* TIER 2 */										                                                                                                                                
												                                                                                                                                            
			(	'BUILDING_COREXB_TIER2_CUL_NEG_PROD_DIST',				'MODIFIER_SINGLE_CITY_ADJUST_DISTRICT_PRODUCTION_MODIFIER',		 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXB_TIER2_CUL_EXTRA_DIST',					'MODIFIER_SINGLE_CITY_EXTRA_DISTRICT',							 1,			1,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXB_TIER2_CUL_APPEAL',						'MODIFIER_SINGLE_CITY_ADJUST_CITY_APPEAL',						 1,			1,			NULL,						NULL,							NULL											),
										                                                                                                                                                    
			(	'BUILDING_COREXB_TIER2_GOL_EXTRA_POP',					'MODIFIER_COREX_SINGLE_CITY_ADJUST_POPULATION',					 1,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXB_TIER2_GOL_EXTRA_GROWTH',				'MODIFIER_SINGLE_CITY_ADJUST_CITY_GROWTH',						 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXB_TIER2_GOL_NEG_AMEN',					'MODIFIER_COREX_SINGLE_CITY_ADJUST_POL_AMENITY',				 0,			0,			NULL,						NULL,							NULL											),		
			(	'BUILDING_COREXB_TIER2_GOL_NEG_LOYALTY',				'MODIFIER_SINGLE_CITY_ADJUST_IDENTITY_PER_TURN',				 0,			0,			NULL,						NULL,							NULL											),		
			(	'PROJECT_COREXB_TIER2_GOL_NEG_LOYALTY',					'MODIFIER_SINGLE_CITY_ADJUST_IDENTITY_PER_TURN',				 0,			0,			NULL,						NULL,							NULL											),		
			(	'PROJECT_COREXB_TIER2_GOL_IMMIGRATION',					'MODIFIER_COREX_SINGLE_CITY_ADJUST_POPULATION',					 1,			0,			NULL,						NULL,							NULL											),
										                                                                                                                                                    
			(	'BUILDING_COREXB_TIER2_SCI_YIELD_CUL',					'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER',				 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXB_TIER2_SCI_YIELD_SCI',					'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER',				 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXB_TIER2_SCI_NEG_YIELD_PROD',				'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER',				 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXB_TIER2_SCI_NEG_YIELD_GOLD',				'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER',				 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXB_TIER2_SCI_AMEN',						'MODIFIER_COREX_SINGLE_CITY_ADJUST_POL_AMENITY',				 0,			0,			NULL,						NULL,							NULL											),		
	...
	/* BUILDING C */								                                                                                                                                        
		...
		/* TIER 1 */								                                                                                                                                        
			...
			(	'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_CUL_2',			'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS',						 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_COREXC_TIER1_CUL'			),
			(	'BUILDING_COREXC_TIER1_CUL_RESORT_YIELD_CUL_2',			'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_RESORT'					),
			(	'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_CUL_1',			'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS',						 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_COREXC_TIER1_CUL_WONDER'	),
			(	'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_GOL_2',			'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS',						 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_COREXC_TIER1_CUL_WONDER'	),
			(	'BUILDING_COREXC_TIER1_CUL_RESORT_YIELD_CUL_1',			'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_RESORT_WONDER'				),
			(	'BUILDING_COREXC_TIER1_CUL_RESORT_YIELD_GOL_2',			'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_RESORT_WONDER'				),
										                                                                                                                                                    
			(	'BUILDING_COREXC_TIER1_SCI_CHAR_HOODS',					'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_APPEAL',		 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_SCI_BRTH_HOODS',					'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_APPEAL',		 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_SCI_BRTH_8_HOODS',				'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_APPEAL',		 0,			0,			NULL,						NULL,							NULL											),
							                                                                                                                                                            
			(	'BUILDING_COREXC_TIER1_GOL_NEIB_GOL',					'MODIFIER_COREX_SINGLE_CITY_ADJUST_DISTRICT_ADJ',				 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_GOL_NEIB_PROD',					'MODIFIER_COREX_SINGLE_CITY_ADJUST_DIS_PROD',					 0,			0,			NULL,						NULL,							NULL											),


												                                                                                                                                            
		/* TIER 2 */												                                                                                                                        
												                                                                                                                                            
			(	'BUILDING_COREXC_TIER2_SCI_CITY_GEO_PLANT_GOL_1',		'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',	 				 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_GEO_PLANT'					),
			(	'BUILDING_COREXC_TIER2_SCI_CITY_GEO_PLANT_PROD_1',		'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',	 				 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_GEO_PLANT'					),
			(	'BUILDING_COREXC_TIER2_SCI_WIND_FARM_GOL_1',			'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',	 				 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_WIND_FARM'					),
			(	'BUILDING_COREXC_TIER2_SCI_WIND_FARM_PROD_1',			'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',	 				 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_WIND_FARM'					),
			(	'BUILDING_COREXC_TIER2_SCI_SOLAR_FARM_GOL_1',			'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',	 				 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_SOLAR_FARM'				),
			(	'BUILDING_COREXC_TIER2_SCI_SOLAR_FARM_PROD_1',			'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',	 				 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_SOLAR_FARM'				),
			(	'BUILDING_COREXC_TIER2_SCI_OFFWND_GOL_1',				'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',	 				 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_OFFSHORE_WIND'				),
			(	'BUILDING_COREXC_TIER2_SCI_OFFWND_PROD_1',				'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',	 				 0,			0,			NULL,						NULL,							'COREXC_SET_PLOT_HAS_OFFSHORE_WIND'				),
			(	'BUILDING_COREXC_TIER2_SCI_MISC_PWR_4',					'MODIFIER_PLAYER_CITIES_ADJUST_FREE_POWER',	 					 0,			0,			NULL,						NULL,							NULL											),				
			(	'BUILDING_COREXC_TIER2_SCI_NUCLEAR_GOL_1',				'MODIFIER_BUILDING_YIELD_CHANGE',	 							 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER2_SCI_NUCLEAR_PROD_1',				'MODIFIER_BUILDING_YIELD_CHANGE',	 							 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER2_SCI_HYDRO_GOL_1',				'MODIFIER_BUILDING_YIELD_CHANGE',	 							 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER2_SCI_HYDRO_PROD_1',				'MODIFIER_BUILDING_YIELD_CHANGE',	 							 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER2_SCI_COAL_GOL_1',					'MODIFIER_BUILDING_YIELD_CHANGE',	 							 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER2_SCI_COAL_PROD_1',				'MODIFIER_BUILDING_YIELD_CHANGE',	 							 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER2_SCI_FOSSIL_GOL_1',				'MODIFIER_BUILDING_YIELD_CHANGE',	 							 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER2_SCI_FOSSIL_PROD_1',				'MODIFIER_BUILDING_YIELD_CHANGE',	 							 0,			0,			NULL,						NULL,							NULL											),
								                                                                                                                                                            
			(	'BUILDING_COREXC_TIER2_GOL_COREXA_ADJACENCY_YIELD',		'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',0,		0,			NULL,						'1',							'COREXC_SET_DISTRICT_IS_COREXA'					),
			(	'BUILDING_COREXC_TIER2_GOL_COREXB_ADJACENCY_YIELD',		'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',0,		0,			NULL,						'1',							'COREXC_SET_DISTRICT_IS_COREXB'					),
			(	'BUILDING_COREXC_TIER2_GOL_COREXC_ADJACENCY_YIELD',		'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS',0,		0,			NULL,						'1',							'COREXC_SET_DISTRICT_IS_COREXC'					),

			(	'BUILDING_COREXC_TIER2_CUL_GRANT_CIV_ENG',				'MODIFIER_SINGLE_CITY_GRANT_UNIT_IN_CITY',		   				 1,			1,			NULL,						NULL,							NULL											),
			
		/* NATIONAL */												                                                                                                                        

			(	'BUILDING_COREX_NATIONAL_GOL_TREASURY',					'MODIFIER_PLAYER_MULTIPLY_TREASURY',							 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREX_NATIONAL_GOL_GOLD_YIELD',				'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER',		   		 0,			0,			NULL,						NULL,							NULL											),
								                                                                                                                                                            
			(	'BUILDING_COREX_NATIONAL_CUL_GRANT_NAT',				'MODIFIER_SINGLE_CITY_GRANT_UNIT_IN_CITY',		   				 1,			1,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREX_NATIONAL_CUL_ALCAZAR_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_ALCAZAR'				),
			(	'BUILDING_COREX_NATIONAL_CUL_CAHOKIA_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_CAHOKIA'				),
			(	'BUILDING_COREX_NATIONAL_CUL_HEADS_CUL_1',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_HEADS'				),
			(	'BUILDING_COREX_NATIONAL_CUL_MOAI_CUL_1',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_MOAI'					),
			(	'BUILDING_COREX_NATIONAL_CUL_MONASTERY_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_MONASTERY'			),
			(	'BUILDING_COREX_NATIONAL_CUL_NAZCA_CUL_1',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_NAZCA'				),
			(	'BUILDING_COREX_NATIONAL_CUL_CHATEAU_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_CHATEAU'				),
			(	'BUILDING_COREX_NATIONAL_CUL_CHEMAMULL_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_CHEMAMULL'			),
			(	'BUILDING_COREX_NATIONAL_CUL_ROMAN_CUL_1',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_ROMAN'				),
			(	'BUILDING_COREX_NATIONAL_CUL_GOLF_CUL_1',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_GOLF'					),
			(	'BUILDING_COREX_NATIONAL_CUL_GREATWALL_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_GREATWALL'			),
			(	'BUILDING_COREX_NATIONAL_CUL_HOCKEY_CUL_1',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_HOCKEY'				),
			(	'BUILDING_COREX_NATIONAL_CUL_KAMPUNG_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_KAMPUNG'				),
			(	'BUILDING_COREX_NATIONAL_CUL_KURGAN_CUL_1',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_KURGAN'				),
			(	'BUILDING_COREX_NATIONAL_CUL_MEKEWAP_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_MEKEWAP'				),
			(	'BUILDING_COREX_NATIONAL_CUL_MISSION_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_MISSION'				),
			(	'BUILDING_COREX_NATIONAL_CUL_NUBIANPYR_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_NUBIANPYR'			),
			(	'BUILDING_COREX_NATIONAL_CUL_OPENMUSEUM_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_OPENMUSEUM'			),
			(	'BUILDING_COREX_NATIONAL_CUL_OUTBACKSTA_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_OUTBACKSTA'			),
			(	'BUILDING_COREX_NATIONAL_CUL_PA_CUL_1',					'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_PA'					),
			(	'BUILDING_COREX_NATIONAL_CUL_PAIRIDAEZA_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_PAIRIDAEZA'			),
			(	'BUILDING_COREX_NATIONAL_CUL_POLDER_CUL_1',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_POLDER'				),
			(	'BUILDING_COREX_NATIONAL_CUL_SPHINX_CUL_1',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_SPHINX'				),
			(	'BUILDING_COREX_NATIONAL_CUL_STEPWELL_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_STEPWELL'				),
			(	'BUILDING_COREX_NATIONAL_CUL_TERRACEFARM_CUL_1',		'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_TERRACEFARM'			),
			(	'BUILDING_COREX_NATIONAL_CUL_ZIGGURAT_CUL_1',			'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREX_SET_COREX_PLOT_HAS_ZIGGURAT'				),
			(	'BUILDING_COREX_NATIONAL_CUL_NAT_PARK_TOUR',			'MODIFIER_COREX_PLAYER_CITIES_ADJUST_NAT_PARK_TOUR',	 		 0,			0,			NULL,						NULL,							NULL											),
								                                                                                                                                                            
			(	'BUILDING_COREX_NATIONAL_SCI_SPACE_ADJACENY',			'MODIFIER_COREX_SINGLE_CITY_ADJUST_DISTRICT_ADJ',				 0,			0,			NULL,						NULL,							NULL											),
			(	'PROJECT_COREX_NATIONAL_SCI_SPACE_RACE',				'MODIFIER_PLAYER_CITIES_ADJUST_SPACE_RACE_PROJECTS_PRODUCTION',	 0,			0,			NULL,						NULL,							NULL											),



												                                                                                                                                            
			(	'GAME_COREEX_DISTRICT_COREXA_UNLOCK',					'MODIFIER_COREEX_GAME_DISTRICT_UNLOCK',	 						0,			0,			NULL,						NULL,							'COREXA_PLAYER_ERA_IS_SET'						),
										                                                                                                                                                    
										                                                                                                                                                    
										                                                                                                                                                    
											                                                                                                                                                
			(	'BUILDING_COREXA_TIER3_TOUR_PARK_GOLD',					'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER',		   		 0,			0,			NULL,						NULL,							'COREXA_SET_CITY_HAS_NAT_PARK'					),
			(	'BUILDING_COREXA_TIER3_TOUR_AIRP_GOLD',					'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER',		   		 0,			0,			NULL,						NULL,							'COREXA_SET_CITY_HAS_DIS_AIRP'					),
			(	'BUILDING_COREXA_TIER3_TOUR_ALL',						'MODIFIER_PLAYER_ADJUST_TOURISM',								 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER3_GP_POINTS_MER',					'MODIFIER_SINGLE_CITY_DISTRICTS_ADJUST_GREAT_PERSON_POINTS',	 0,			0,			NULL,						NULL,							'COREXA_SET_CITY_HAS_DIS_COMMER'				),
			(	'BUILDING_COREXC_TIER1_SCI_LIB_PUR',					'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PURCHASE_COST',			 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_SCI_UNI_PUR',					'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PURCHASE_COST',			 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_SCI_LIBRAR_AMEN',				'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY',					 0,			0,			NULL,						NULL,							'COREXA_SET_CITY_HAS_LIBRARY'					),
			(	'BUILDING_COREXC_TIER1_SCI_UNI_AMEN',					'MODIFIER_PLAYER_CITIES_ADJUST_POLICY_AMENITY',					 0,			0,			NULL,						NULL,							'COREXA_SET_CITY_HAS_UNI'						),
			(	'BUILDING_COREXA_TIER3_AGRI_FARMS_FOOD',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREXA_SET_AGRI_FARM_REQS'						),
			(	'BUILDING_COREXA_TIER3_AGRI_FARMS_PROD',				'MODIFIER_PLAYER_ADJUST_PLOT_YIELD',	 						 0,			0,			NULL,						NULL,							'COREXA_SET_AGRI_FARM_REQS'						),
			(	'BUILDING_COREXA_TIER3_AGRI_GRAIN_PROD',				'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION',	 		 0,			0,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER3_AGRI_FREE_POP',					'MODIFIER_PLAYER_BUILT_CITIES_GRANT_FREE_POPULATION',	 		 0,			1,			NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER3_ECON_BRTH_HOODS',				'MODIFIER_COREX_SINGLE_CITY_ADJUST_DISTRICT_ADJ',				 0,			0,			NULL,						NULL,							NULL											);			
	...
	/* BUILDING B */                                                                            		
		...
		/* TIER 2 */                                                                            		
			...
			(	'PROJECT_COREXB_TIER2_GOL_NEG_LOYALTY',					'Amount',					'-4'								),
			(	'PROJECT_COREXB_TIER2_GOL_IMMIGRATION',					'Amount',					'1'									),
	...
	/* BUILDING C */                                                                            	
		...
		/* TIER 1 */                                                                            	
			...
			(	'BUILDING_COREXC_TIER1_SCI_BRTH_8_HOODS',				'RequiredAppeal',			'8'									),
			...
			(	'BUILDING_COREXC_TIER1_GOL_NEIB_PROD',					'Amount',					'50'								),
			(	'BUILDING_COREXC_TIER1_GOL_NEIB_PROD',					'DistrictType',				'DISTRICT_NEIGHBORHOOD'				),		
		...
		/* NATIONAL */												                                                                                                                        
			...
			(	'BUILDING_COREX_NATIONAL_CUL_GRANT_NAT',				'Amount',					'2'									),
...
--===========================================================================================================================================================================--			
		...
		INSERT INTO Projects
			...
			(	'PROJECT_COREX_PUBLISHERS',			'LOC_PROJECT_COREX_PUBLISHERS_NAME',	'LOC_PROJECT_COREX_PUBLISHERS_SHORT_NAME',		'LOC_PROJECT_COREX_PUBLISHERS_DESCRIPTION',		'25',				'COST_PROGRESSION_GAME_PROGRESS',	'1500',						'TECH_PRINTING',	'DISTRICT_THEATER',			NULL,							'ADVISOR_CULTURE'		),
			...
			(	'PROJECT_COREX_IMMIGRATION',		'LOC_PROJECT_COREX_IMMIGRATION_NAME',	'LOC_PROJECT_COREX_IMMIGRATION_SHORT_NAME',		'LOC_PROJECT_COREX_IMMIGRATION_DESCRIPTION',	'25',				'COST_PROGRESSION_GAME_PROGRESS',	'1500',						NULL,				NULL,						'-2',							'ADVISOR_GENERIC'		);

		INSERT INTO Projects_XP2
			(	ProjectType,						RequiredBuilding					)	VALUES
			(	'PROJECT_COREX_PUBLISHERS',			'BUILDING_COREXB_TIER1_CUL'			),
			(	'PROJECT_COREX_SPACE_RACE',			'BUILDING_COREX_NATIONAL_SCI'		),
			(	'PROJECT_COREX_IMMIGRATION',		'BUILDING_COREXB_TIER2_GOL'			);
		...
		INSERT INTO ProjectCompletionModifiers
			...
			(	'PROJECT_COREX_IMMIGRATION',		'PROJECT_COREXB_TIER2_GOL_IMMIGRATION'	),
			(	'PROJECT_COREX_IMMIGRATION',		'PROJECT_COREXB_TIER2_GOL_NEG_LOYALTY'	);
...
--===========================================================================================================================================================================--			
		...
		INSERT INTO Units
			...
			(	'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',			'LOC_UNIT_COREXC_TIER2_CUL_CIVIL_ENG_NAME',			'2',						'2',					'DOMAIN_LAND',		'FORMATION_CLASS_CIVILIAN',		'330',		'3',				'LOC_UNIT_COREXC_TIER2_CUL_CIVIL_ENG_DESCRIPTION',		'COST_PROGRESSION_PREVIOUS_COPIES',			'4',							'YIELD_GOLD',			'ADVISOR_GENERIC'		);
		...
		INSERT INTO District_BuildChargeProductions
			...
			(	'DISTRICT_NEIGHBORHOOD',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'DISTRICT_AQUEDUCT',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'DISTRICT_ACROPOLIS',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'DISTRICT_BATH',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'DISTRICT_HANSA',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'DISTRICT_LAVRA',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'DISTRICT_MBANZA',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			...
			(	'DISTRICT_CANAL',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'DISTRICT_DAM',									'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
		...
		INSERT INTO Building_BuildChargeProductions
			...
			(	'BUILDING_MONUMENT',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_GRANARY',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_LIBRARY',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_SHRINE',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_WATER_MILL',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_ARENA',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_LIGHTHOUSE',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_MARKET',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_TEMPLE',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_STAVE_CHURCH',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_AMPHITHEATER',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_UNIVERSITY',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_MADRASA',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_WORKSHOP',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_SHIPYARD',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_BANK',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_MUSEUM_ART',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_MUSEUM_ARTIFACT',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_FACTORY',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_ELECTRONICS_FACTORY',					'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_STOCK_EXCHANGE',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_SEWER',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_ZOO',									'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			...
			(	'BUILDING_CATHEDRAL',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_GURDWARA',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_MEETING_HOUSE',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_MOSQUE',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_PAGODA',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_SYNAGOGUE',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_WAT',									'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_STUPA',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_DAR_E_MEHR',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_TLACHTLI',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_PRASAT',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_SUKIENNICE',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_FERRIS_WHEEL',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_AQUARIUM',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_AQUATICS_CENTER',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_GOV_TALL',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_GOV_WIDE',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_GOV_CONQUEST',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_GOV_CITYSTATES',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_GOV_SPIES',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_GOV_FAITH',							'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			...
			(	'BUILDING_FLOOD_BARRIER',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_HYDROELECTRIC_DAM',					'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_COAL_POWER_PLANT',					'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_FOSSIL_FUEL_POWER_PLANT',				'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_GRAND_BAZAAR',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_MARAE',								'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_QUEENS_BIBLIOTHEQUE',					'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							),
			(	'BUILDING_THERMAL_BATH',						'UNIT_COREXC_TIER2_CUL_CIVIL_ENG',		'20'							);
