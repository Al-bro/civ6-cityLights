...
--===========================================================================================================================================================================--			
	...
	/* BUILDING C */	
			...
			(	'COREXC_SET_DISTRICT_IS_COREXA',					'BUILDING_COREXC_TIER2_GOL'					),
			(	'COREXC_SET_DISTRICT_IS_COREXB',					'COREXC_DISTRICT_IS_COREXB'					),
			(	'COREXC_SET_DISTRICT_IS_COREXB',					'BUILDING_COREXC_TIER2_GOL'					),
			(	'COREXC_SET_DISTRICT_IS_COREXC',					'COREXC_DISTRICT_IS_COREXC'					),
			(	'COREXC_SET_DISTRICT_IS_COREXC',					'BUILDING_COREXC_TIER2_GOL'					),
