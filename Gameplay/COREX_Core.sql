...
--===========================================================================================================================================================================--
		...
		INSERT INTO DynamicModifiers 
			...
			(	'BUILDING_COREX_SINGLE_CITY_ADJUST_GREATWORK_YIELD',							'COLLECTION_OWNER_CITY',			'EFFECT_ADJUST_CITY_GREATWORK_YIELD'																),			
	...
	*/
	...
	/* BUILDING B */										                                                                                                                                							
		...
		/* TIER 1 */										                                                                                                                                							
			...
			(	'PROJECT_COREXB_TIER1_CUL_PUBLISHERS',					'MODIFIER_PLAYER_GRANT_YIELD_BASED_ON_CURRENT_YIELD_RATE',		 1,			1,			NULL,						NULL,						'3',							NULL											),
			(	'PROJECT_COREXB_TIER1_CUL_GREATWORK_YIELD',				'BUILDING_COREX_SINGLE_CITY_ADJUST_GREATWORK_YIELD',			 0,			0,			NULL,						NULL,						'3',							NULL											),		
	...
	*/
			(	'PROJECT_COREXB_TIER1_SCI_CONFERENCE',					'MODIFIER_PLAYER_GRANT_YIELD_BASED_ON_CURRENT_YIELD_RATE',		 1,			1,			NULL,						NULL,						'3',							NULL											),
			...
			(	'PROJECT_COREXB_TIER1_GOL_GRANT_TRDR',					'MODIFIER_SINGLE_CITY_GRANT_UNIT_IN_CITY',		   				 1,			1,			NULL,						NULL,						'3',							NULL											),																																																					
			(	'PROJECT_COREXB_TIER1_GOL_EXTRA_TRD_ROUTE',				'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_CAPACITY',			   		 1,			1,			NULL,						NULL,						'3',							NULL											),
			(	'PROJECT_COREXB_TIER1_GOL_TRD_TOURE_YIELD_PRE_LUX',		'MODIFIER_COREX_SINGLE_CITY_ADJUST_TRADE_ROUTE_YIELD_PER_LUX',	 0,			0,			NULL,						NULL,						'3',							NULL											),
			(	'PROJECT_COREXB_TIER1_GOL_TRD_TOURE_YIELD_PRE_SRAT',	'MODIFIER_COREX_SINGLE_CITY_ADJUST_TRADE_ROUTE_YIELD_PER_SRAT',	 0,			0,			NULL,						NULL,						'3',							NULL											),
