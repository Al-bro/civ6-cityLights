...
--===========================================================================================================================================================================--		
	...
	/* BUILDING C */	
		...
		/* TIER 1 */
			...
			(	'BUILDING_COREXC_TIER1_CUL',				'BUILDING_COREXC_TIER1_CUL_BUILD_RESORT'					),
			(	'BUILDING_COREXC_TIER1_CUL',				'BUILDING_COREXC_TIER1_CUL_BUILD_SKI'						),
...
--===========================================================================================================================================================================--					
	...
	/* BUILDING C */
		...
		/* TIER 1 */
			...
			(	'IMPROVEMENT_SKI_RESORT',														'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_CUL_2'					),			
			(	'IMPROVEMENT_SKI_RESORT',														'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_CUL_1'					),			
			(	'IMPROVEMENT_SKI_RESORT',														'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_GOL_2'					);			
...
--===========================================================================================================================================================================--				
	...
	*/																																															
	...
	/* BUILDING C */								                                                                                                                                        							
		...
		/* TIER 1 */								                                                                                                                                        							
			...
			(	'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_CUL_1',			'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS',						 0,			0,			NULL,						'1',						NULL,							'COREX_SET_PLOT_HAS_COREXC_TIER1_CUL_WONDER'	),
			(	'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_GOL_2',			'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS',						 0,			0,			NULL,						'1',						NULL,							'COREX_SET_PLOT_HAS_COREXC_TIER1_CUL_WONDER'	),
	...
	*/			
		...
		INSERT INTO Modifiers 
			(	ModifierId,												ModifierType,									 				RunOnce,	NewOnly,	OwnerStackLimit,			SubjectStackLimit,				OwnerRequirementSetId							)	VALUES
		
	/* CORE EXPANSION */			
		
			(	'PROJECT_COREXC_TIER1_SCI_REASERCH',					'MODIFIER_PLAYER_GRANT_RANDOM_TECHNOLOGY_BOOST_GOODY_HUT',		'1',			'1',							NULL,						NULL,							'COREXC_SET_CITY_HAS_TIER1_SCI'					);
...
/* DEPRECATED
	 ...
	 */
			...
			(	'PROJECT_COREXC_TIER1_SCI_REASERCH',					'Amount',					'1'								),
...
--===========================================================================================================================================================================--			
	...
	*/
		INSERT INTO Requirements
			(	RequirementId,							RequirementType,									Persistent			)	VALUES

			(	'COREXC_CITY_HAS_COREXC_TIER1_SCI',		'REQUIREMENT_CITY_HAS_BUILDING',					'1'				);
...
--===========================================================================================================================================================================--		
	...
	/* BUILDING C */	
			...
			(	'COREXC_CITY_HAS_COREXC_TIER1_SCI',		'BuildingType',		'BUILDING_COREXC_TIER1_SCI'			);
...
--===========================================================================================================================================================================--				
	...
	/* BUILDING C */	
			...
			(	'COREXC_SET_CITY_HAS_TIER1_SCI',					'COREXC_CITY_HAS_COREXC_TIER1_SCI'			);
...
--===========================================================================================================================================================================--	
		...
		INSERT INTO Improvement_YieldChanges
			...
			(	'IMPROVEMENT_SKI_RESORT',			'YIELD_GOLD',				0						);
...
--===========================================================================================================================================================================--		
		INSERT INTO ProjectCompletionModifiers
			...
			(	'PROJECT_ENHANCE_DISTRICT_CAMPUS',	'PROJECT_COREXC_TIER1_SCI_REASERCH'					),
