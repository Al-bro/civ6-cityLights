...
--===========================================================================================================================================================================--				
	...
	*/
			...
			(	'BUILDING_COREXA_TIER2_CUL_APPEAL_ENTERTAIN',			'MODIFIER_SINGLE_CITY_ADJUST_CITY_APPEAL',						 1,			1,			NULL,						NULL,						NULL,							'COREXA_SET_PLOT_NEAR_ENTERTAIN'				),
			(	'BUILDING_COREXA_TIER2_CUL_APPEAL_WATERFRONT',			'MODIFIER_SINGLE_CITY_ADJUST_CITY_APPEAL',						 1,			1,			NULL,						NULL,						NULL,							'COREXA_SET_PLOT_NEAR_WATERFRONT'				),
	...
	*/																																															
			(	'BUILDING_COREXC_TIER1_GOL_STOCK_CAMPUS',				'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 		 0,		0,		NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_GOL_STOCK_COMMERCIAL',			'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 		 0,		0,		NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_GOL_STOCK_HARBOR',				'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 		 0,		0,		NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_GOL_STOCK_INDUSTRIAL',			'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 		 0,		0,		NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_GOL_STOCK_THEATER',				'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 		 0,		0,		NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_GOL_STOCK_ENTERTAINMENT',		'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 		 0,		0,		NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_GOL_STOCK_WATERPARK',			'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 		 0,		0,		NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_GOL_STOCK_AERODOME',				'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 		 0,		0,		NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_GOL_STOCK_HOLYSITE',				'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 		 0,		0,		NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXC_TIER1_GOL_STOCK_ENCAMPMENT',			'BUILDING_COREX_SINGLE_CITY_ADJUST_BUILDING_YIELD_CHANGE',		 		 0,		0,		NULL,						NULL,						NULL,							NULL											),
...
--===========================================================================================================================================================================--		
	...
	/* BUILDING A*/			
			...
			(	'COREXA_SET_DISTRICT_IS_ENTERTAIN',				'REQUIREMENTSET_TEST_ANY'	),
			(	'COREXA_SET_DISTRICT_IS_WATERFRONT',			'REQUIREMENTSET_TEST_ANY'	),
			(	'COREXA_SET_PLOT_NEAR_ENTERTAIN',				'REQUIREMENTSET_TEST_ANY'	),
			(	'COREXA_SET_PLOT_NEAR_WATERFRONT',				'REQUIREMENTSET_TEST_ANY'	),
...
--===========================================================================================================================================================================--				
	...
	/* BUILDING A */				
			...
			(	'COREXA_SET_DISTRICT_IS_ENTERTAIN',					'REQUIRES_DISTRICT_IS_ENTERTAINMENT_COMPLEX'),
			(	'COREXA_SET_DISTRICT_IS_ENTERTAIN',					'COREXA_DISTRICT_IS_CARNIVAL'				),
			(	'COREXA_SET_DISTRICT_IS_WATERFRONT',				'COREXA_DISTRICT_IS_WATERFRONT'				),
			(	'COREXA_SET_DISTRICT_IS_WATERFRONT',				'COREXA_DISTRICT_IS_WATER_CARNIVAL'			),
			(	'COREXA_SET_PLOT_NEAR_ENTERTAIN',					'COREXA_PLOT_NEAR_ENTERTAIN'				),
			(	'COREXA_SET_PLOT_NEAR_ENTERTAIN',					'COREXA_PLOT_NEAR_CARNIVAL'					),
			(	'COREXA_SET_PLOT_NEAR_WATERFRONT',					'COREXA_PLOT_NEAR_WATERFRONT'				),
			(	'COREXA_SET_PLOT_NEAR_WATERFRONT',					'COREXA_PLOT_NEAR_WATER_CARNIVAL'			),
