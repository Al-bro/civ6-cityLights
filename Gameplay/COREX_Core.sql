...
--===========================================================================================================================================================================--		
	...
	/* BUILDING A */
		...
		/* TIER 2 */
			...
			(	'BUILDING_COREXA_TIER2_CUL',				'BUILDING_COREXA_TIER2_CUL_FAITH_PUR_ENTERTAIN'				),
			(	'BUILDING_COREXA_TIER2_CUL',				'BUILDING_COREXA_TIER2_CUL_FAITH_PUR_WATERFRONT'			),
			(	'BUILDING_COREXA_TIER2_CUL',				'BUILDING_COREXA_TIER2_CUL_APPEAL_ENTERTAIN'				),
			(	'BUILDING_COREXA_TIER2_CUL',				'BUILDING_COREXA_TIER2_CUL_APPEAL_WATERFRONT'				),
			...
			(	'BUILDING_COREXA_TIER2_GOL',				'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_MARKET'				),			
			(	'BUILDING_COREXA_TIER2_GOL',				'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_BANK'				),			
			(	'BUILDING_COREXA_TIER2_GOL',				'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_STOCK'				),			
			(	'BUILDING_COREXA_TIER2_GOL',				'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_LIGHT'				),			
			(	'BUILDING_COREXA_TIER2_GOL',				'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_SHIPYARD'			),			
			(	'BUILDING_COREXA_TIER2_GOL',				'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_SEAPORT'				),			
			(	'BUILDING_COREXA_TIER2_GOL',				'BUILDING_COREXA_TIER2_GOL_HARBOR_ADJACENT_GOL'				),			
	...
	/* BUILDING C */	
		...
		/* TIER 1 */
			...
			(	'BUILDING_COREXC_TIER1_GOL',				'BUILDING_COREXC_TIER1_GOL_STOCK_CAMPUS'					),
			(	'BUILDING_COREXC_TIER1_GOL',				'BUILDING_COREXC_TIER1_GOL_STOCK_COMMERCIAL'				),
			(	'BUILDING_COREXC_TIER1_GOL',				'BUILDING_COREXC_TIER1_GOL_STOCK_HARBOR'					),
			(	'BUILDING_COREXC_TIER1_GOL',				'BUILDING_COREXC_TIER1_GOL_STOCK_INDUSTRIAL'				),
			(	'BUILDING_COREXC_TIER1_GOL',				'BUILDING_COREXC_TIER1_GOL_STOCK_THEATER'					),
			(	'BUILDING_COREXC_TIER1_GOL',				'BUILDING_COREXC_TIER1_GOL_STOCK_ENTERTAINMENT'				),
			(	'BUILDING_COREXC_TIER1_GOL',				'BUILDING_COREXC_TIER1_GOL_STOCK_WATERPARK'					),
			(	'BUILDING_COREXC_TIER1_GOL',				'BUILDING_COREXC_TIER1_GOL_STOCK_AERODOME'					),
			(	'BUILDING_COREXC_TIER1_GOL',				'BUILDING_COREXC_TIER1_GOL_STOCK_HOLYSITE'					),
			(	'BUILDING_COREXC_TIER1_GOL',				'BUILDING_COREXC_TIER1_GOL_STOCK_ENCAMPMENT'				),
...
--===========================================================================================================================================================================--
		...
		INSERT INTO DynamicModifiers 
			...
			(	'MODIFIER_COREX_SINGLE_CITY_DISTRICTS_ADJACENCY_BONUS',							'COLLECTION_OWNER_CITY',			'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_BASED_ON_ADJACENCY_BONUS'															),			
...
--===========================================================================================================================================================================--				
	...
	*/
			...
			(	'BUILDING_COREXA_TIER1_SCI_GRANT_LIB',					'MODIFIER_SINGLE_CITY_GRANT_BUILDING_IN_CITY_IGNORE',			 1,			1,			NULL,						NULL,						NULL,							'COREX_SET_CITY_HAS_CAMPUS'					),		
																																															
			(	'BUILDING_COREXA_TIER1_GOL_GRANT_MARKET',				'MODIFIER_SINGLE_CITY_GRANT_BUILDING_IN_CITY_IGNORE',			 1,			1,			NULL,						NULL,						NULL,							'COREX_SET_CITY_HAS_COMMERCIAL_HUB'			),		
			...
			(	'BUILDING_COREXA_TIER1_CUL_GRANT_AMP',					'MODIFIER_SINGLE_CITY_GRANT_BUILDING_IN_CITY_IGNORE',			 1,			1,			NULL,						NULL,						NULL,							'COREX_SET_CITY_HAS_THEATER_SQUARE'			),																																																								
	...
	*/
			...
			(	'BUILDING_COREXA_TIER2_CUL_FAITH_PUR_ENTERTAIN',		'MODIFIER_CITY_ENABLE_BUILDING_FAITH_PURCHASE',					 0,			0,			NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_CUL_FAITH_PUR_WATERFRONT',		'MODIFIER_CITY_ENABLE_BUILDING_FAITH_PURCHASE',					 0,			0,			NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_CUL_APPEAL_ENTERTAIN',			'MODIFIER_SINGLE_CITY_ADJUST_CITY_APPEAL',						 1,			1,			NULL,						NULL,						NULL,							'COREX_SET_PLOT_NEAR_ENTERTAIN'				),
			(	'BUILDING_COREXA_TIER2_CUL_APPEAL_WATERFRONT',			'MODIFIER_SINGLE_CITY_ADJUST_CITY_APPEAL',						 1,			1,			NULL,						NULL,						NULL,							'COREX_SET_PLOT_NEAR_WATERFRONT'				),
	...
	*/		
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_MARKET',			'MODIFIER_COREX_SINGLE_CITY_ADJUST_BUILDING_PURCHASE',			 0,			0,			NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_BANK',			'MODIFIER_COREX_SINGLE_CITY_ADJUST_BUILDING_PURCHASE',			 0,			0,			NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_STOCK',			'MODIFIER_COREX_SINGLE_CITY_ADJUST_BUILDING_PURCHASE',			 0,			0,			NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_LIGHT',			'MODIFIER_COREX_SINGLE_CITY_ADJUST_BUILDING_PURCHASE',			 0,			0,			NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_SHIPYARD',		'MODIFIER_COREX_SINGLE_CITY_ADJUST_BUILDING_PURCHASE',			 0,			0,			NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_SEAPORT',		'MODIFIER_COREX_SINGLE_CITY_ADJUST_BUILDING_PURCHASE',			 0,			0,			NULL,						NULL,						NULL,							NULL											),
			(	'BUILDING_COREXA_TIER2_GOL_HARBOR_ADJACENT_GOL',		'MODIFIER_COREX_SINGLE_CITY_ADJUST_DISTRICT_ADJ',				 0,			0,			NULL,						NULL,						NULL,							NULL											),
	...
	/* BUILDING B */										                                                                                                                                							
		...
		/* TIER 1 */										                                                                                                                                							
			...
			(	'BUILDING_COREXB_TIER1_CUL_YIELD_CUL',					'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER',				 0,			0,			NULL,						NULL,						NULL,							'COREX_SET_PLAYER_HAS_PRINTING'				),
			(	'BUILDING_COREXB_TIER1_CUL_GRANT_PROJ_BUILD',			'MODIFIER_SINGLE_CITY_GRANT_BUILDING_IN_CITY_IGNORE',			 1,			1,			NULL,						NULL,						NULL,							'COREX_SET_PLAYER_HAS_PRINTING'				),
			...
			(	'BUILDING_COREXB_TIER1_SCI_YIELD_SCI',					'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER',				 0,			0,			NULL,						NULL,						NULL,							'COREX_SET_CAMPUS_HIGH_ADJACENCY'				),
			(	'BUILDING_COREXB_TIER1_SCI_GRANT_PROJ_BUILD',			'MODIFIER_SINGLE_CITY_GRANT_BUILDING_IN_CITY_IGNORE',			 1,			1,			NULL,						NULL,						NULL,							'COREX_SET_CAMPUS_HIGH_ADJACENCY'				),
	/* DEPRECATED
	...
	*/
			...
			(	'BUILDING_COREXB_TIER2_GOL_HARBOR_ADJACENCY_YIELD',		'MODIFIER_COREX_SINGLE_CITY_DISTRICTS_ADJACENCY_BONUS',   		 0,			0,			NULL,						NULL,						'1',							NULL											),
	...
	*/																																															
	...
	/* BUILDING C */								                                                                                                                                        							
		...
		/* TIER 1 */								                                                                                                                                        							
			...
			(	'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_CUL_2',			'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS',						 0,			0,			NULL,						NULL,						NULL,							'COREX_SET_PLOT_HAS_COREXC_TIER1_CUL'			),
			...
			(	'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_CUL_1',			'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS',						 0,			0,			NULL,						NULL,						NULL,							'COREX_SET_PLOT_HAS_COREXC_TIER1_CUL_WONDER'	),
			(	'BUILDING_COREXC_TIER1_CUL_PARK_YIELD_GOL_2',			'MODIFIER_SINGLE_PLOT_ADJUST_PLOT_YIELDS',						 0,			0,			NULL,						NULL,						NULL,							'COREX_SET_PLOT_HAS_COREXC_TIER1_CUL_WONDER'	),
			(	'BUILDING_COREXC_TIER1_CUL_RESORT_YIELD_CUL_1',			'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,						NULL,							'COREX_SET_PLOT_HAS_RESORT_WONDER'				),
			(	'BUILDING_COREXC_TIER1_CUL_RESORT_YIELD_GOL_2',			'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',					 0,			0,			NULL,						NULL,						NULL,							'COREX_SET_PLOT_HAS_RESORT_WONDER'				),
...
--===========================================================================================================================================================================--		
	...
	*/
			...
			(	'BUILDING_COREXA_TIER2_CUL_APPEAL_ENTERTAIN',			'Amount',					'1'									),	
			(	'BUILDING_COREXA_TIER2_CUL_APPEAL_WATERFRONT',			'Amount',					'1'									),	
			(	'BUILDING_COREXA_TIER2_CUL_FAITH_PUR_ENTERTAIN',		'DistrictType',				'DISTRICT_ENTERTAINMENT_COMPLEX'	),	
			(	'BUILDING_COREXA_TIER2_CUL_FAITH_PUR_WATERFRONT',		'DistrictType',			'DISTRICT_WATER_ENTERTAINMENT_COMPLEX'	),	
	...
	*/
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_MARKET',			'BuildingType',				'BUILDING_MARKET'					),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_MARKET',			'Amount',					'50'								),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_BANK',			'BuildingType',				'BUILDING_BANK'						),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_BANK',			'Amount',					'50'								),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_STOCK',			'BuildingType',				'BUILDING_STOCK_EXCHANGE'			),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_STOCK',			'Amount',					'50'								),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_LIGHT',			'BuildingType',				'BUILDING_LIGHTHOUSE'				),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_LIGHT',			'Amount',					'50'								),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_SHIPYARD',		'BuildingType',				'BUILDING_SHIPYARD'					),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_SHIPYARD',		'Amount',					'50'								),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_SEAPORT',		'BuildingType',				'BUILDING_SEAPORT'					),	
			(	'BUILDING_COREXA_TIER2_GOL_BUILD_PURCH_SEAPORT',		'Amount',					'50'								),	
			(	'BUILDING_COREXA_TIER2_GOL_HARBOR_ADJACENT_GOL',		'YieldType',				'YIELD_GOLD'						),
			(	'BUILDING_COREXA_TIER2_GOL_HARBOR_ADJACENT_GOL',		'DistrictType',				'DISTRICT_HARBOR'					),
			(	'BUILDING_COREXA_TIER2_GOL_HARBOR_ADJACENT_GOL',		'Description',				'LOC_COREEX_DISTRICT_GOLD_2'		),
			(	'BUILDING_COREXA_TIER2_GOL_HARBOR_ADJACENT_GOL',		'Amount',					'2'									),		
	...
	*/
			...
			(	'BUILDING_COREXB_TIER2_GOL_EXTRA_GROWTH',				'Amount',					'30'								),
	/* DEPRECATED
...
--===========================================================================================================================================================================--			
	...
	/* BUILDING A */		
			...
			(	'COREX_CITY_HAS_WATERPARK',				'REQUIREMENT_CITY_HAS_DISTRICT',					0		),
			(	'COREX_CITY_HAS_AERODOME',				'REQUIREMENT_CITY_HAS_DISTRICT',					0		),
			(	'COREXA_PLOT_NEAR_ENTERTAIN',			'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES',	0		),
			(	'COREXA_PLOT_NEAR_CARNIVAL',			'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES',	0		),
			(	'COREXA_PLOT_NEAR_WATERFRONT',			'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES',	0		),
			(	'COREXA_PLOT_NEAR_WATER_CARNIVAL',		'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES',	0		),
			(	'COREXA_DISTRICT_IS_CARNIVAL',			'REQUIREMENT_DISTRICT_TYPE_MATCHES',				0		),
			(	'COREXA_DISTRICT_IS_WATERFRONT',		'REQUIREMENT_DISTRICT_TYPE_MATCHES',				0		),
			(	'COREXA_DISTRICT_IS_WATER_CARNIVAL',	'REQUIREMENT_DISTRICT_TYPE_MATCHES',				0		),
...
--===========================================================================================================================================================================--		
	...
	/* BUILDING A */		
			...
			(	'COREX_CITY_HAS_WATERPARK',				'DistrictType',		'DISTRICT_WATER_ENTERTAINMENT_COMPLEX'	),
			(	'COREX_CITY_HAS_AERODOME',				'DistrictType',		'DISTRICT_AERODROME'				),
			(	'COREXA_PLOT_NEAR_ENTERTAIN',			'DistrictType',		'DISTRICT_ENTERTAINMENT_COMPLEX'	),
			(	'COREXA_PLOT_NEAR_ENTERTAIN',			'MaxRange',			'2'									),
			(	'COREXA_PLOT_NEAR_ENTERTAIN',			'MinRange',			'0'									),
			(	'COREXA_PLOT_NEAR_CARNIVAL',			'DistrictType',		'DISTRICT_STREET_CARNIVAL'			),
			(	'COREXA_PLOT_NEAR_CARNIVAL',			'MaxRange',			'2'									),
			(	'COREXA_PLOT_NEAR_CARNIVAL',			'MinRange',			'0'									),
			(	'COREXA_PLOT_NEAR_WATERFRONT',			'DistrictType',		'DISTRICT_WATER_ENTERTAINMENT_COMPLEX'	),
			(	'COREXA_PLOT_NEAR_WATERFRONT',			'MaxRange',			'2'									),
			(	'COREXA_PLOT_NEAR_WATERFRONT',			'MinRange',			'0'									),
			(	'COREXA_PLOT_NEAR_WATER_CARNIVAL',		'DistrictType',		'DISTRICT_WATER_STREET_CARNIVAL'	),
			(	'COREXA_PLOT_NEAR_WATER_CARNIVAL',		'MaxRange',			'2'									),
			(	'COREXA_PLOT_NEAR_WATER_CARNIVAL',		'MinRange',			'0'									),
			(	'COREXA_DISTRICT_IS_CARNIVAL',			'DistrictType',		'DISTRICT_STREET_CARNIVAL'			),
			(	'COREXA_DISTRICT_IS_WATERFRONT',		'DistrictType',		'DISTRICT_WATER_ENTERTAINMENT_COMPLEX'	),
			(	'COREXA_DISTRICT_IS_WATER_CARNIVAL',	'DistrictType',		'DISTRICT_WATER_STREET_CARNIVAL'	),
...
--===========================================================================================================================================================================--		
	...
	/* BUILDING A*/			
			...
			(	'COREX_SET_PLAYER_HAS_NAT_HIST',				'REQUIREMENTSET_TEST_ALL'	),

			(	'COREX_SET_CITY_HAS_MAX_3_DIST',				'REQUIREMENTSET_TEST_ANY'	),
			(	'COREX_SET_DISTRICT_IS_ENTERTAIN',				'REQUIREMENTSET_TEST_ANY'	),
			(	'COREX_SET_DISTRICT_IS_WATERFRONT',				'REQUIREMENTSET_TEST_ANY'	),
			(	'COREX_SET_PLOT_NEAR_ENTERTAIN',				'REQUIREMENTSET_TEST_ANY'	),
			(	'COREX_SET_PLOT_NEAR_WATERFRONT',				'REQUIREMENTSET_TEST_ANY'	),
		
	/* BUILDING B */			
		
			(	'COREX_SET_CAMPUS_HIGH_ADJACENCY',				'REQUIREMENTSET_TEST_ALL'	),

			(	'COREX_SET_PLAYER_HAS_PRINTING',				'REQUIREMENTSET_TEST_ALL'	),

			(	'COREX_SET_CITY_HAS_SHIPYARD',					'REQUIREMENTSET_TEST_ALL'	),
	...
	/* BUILDING C */	
			...
			(	'COREX_SET_PLOT_HAS_COREXC_TIER1_CUL',			'REQUIREMENTSET_TEST_ALL'	),
			(	'COREX_SET_PLOT_HAS_RESORT',					'REQUIREMENTSET_TEST_ALL'	),
			(	'COREX_SET_PLOT_HAS_COREXC_TIER1_CUL_WONDER',	'REQUIREMENTSET_TEST_ALL'	),
			(	'COREX_SET_PLOT_HAS_RESORT_WONDER',				'REQUIREMENTSET_TEST_ALL'	),
...
--===========================================================================================================================================================================--				
	...
	/* BUILDING A */				
			...
			(	'COREX_SET_CITY_HAS_WATERPARK',						'COREX_CITY_HAS_WATERPARK'					),
			(	'COREX_SET_CITY_HAS_AERODOME',						'REQUIRES_CITY_HAS_HOLY_SITE'				),
			(	'COREX_SET_CITY_HAS_HOLYSITE',						'COREX_CITY_HAS_AERODOME'					),
			(	'COREX_SET_CITY_HAS_ENTERTAINMENT',					'COREXA_CITY_HAS_ENTERTAINMENT_DIS'			),
			(	'COREX_SET_PLAYER_HAS_REC_GAMES',					'COREXA_PLAYER_HAS_REC_GAMES'				),
			(	'COREX_SET_PLAYER_HAS_REC_GAMES',					'COREXA_CITY_HAS_ENTERTAINMENT_DIS'			),
			(	'COREX_SET_PLAYER_HAS_NAT_HIST',					'COREXA_PLAYER_HAS_NAT_HIST'				),
			(	'COREX_SET_PLAYER_HAS_NAT_HIST',					'COREXA_CITY_HAS_ENTERTAINMENT_DIS'			),

			(	'COREX_SET_CITY_HAS_MAX_3_DIST',					'REQUIRES_CITY_HAS_0_SPECIALTY_DISTRICTS'	),
			(	'COREX_SET_CITY_HAS_MAX_3_DIST',					'REQUIRES_CITY_HAS_1_SPECIALTY_DISTRICT'	),
			(	'COREX_SET_CITY_HAS_MAX_3_DIST',					'REQUIRES_CITY_HAS_2_SPECIALTY_DISTRICTS'	),
			(	'COREX_SET_DISTRICT_IS_ENTERTAIN',					'REQUIRES_DISTRICT_IS_ENTERTAINMENT_COMPLEX'),
			(	'COREX_SET_DISTRICT_IS_ENTERTAIN',					'COREXA_DISTRICT_IS_CARNIVAL'				),
			(	'COREX_SET_DISTRICT_IS_WATERFRONT',					'COREXA_DISTRICT_IS_WATERFRONT'				),
			(	'COREX_SET_DISTRICT_IS_WATERFRONT',					'COREXA_DISTRICT_IS_WATER_CARNIVAL'			),
			(	'COREX_SET_PLOT_NEAR_ENTERTAIN',					'COREXA_PLOT_NEAR_ENTERTAIN'				),
			(	'COREX_SET_PLOT_NEAR_ENTERTAIN',					'COREXA_PLOT_NEAR_CARNIVAL'					),
			(	'COREX_SET_PLOT_NEAR_WATERFRONT',					'COREXA_PLOT_NEAR_WATERFRONT'				),
			(	'COREX_SET_PLOT_NEAR_WATERFRONT',					'COREXA_PLOT_NEAR_WATER_CARNIVAL'			),
		
	/* BUILDING B */				
			
			(	'COREX_SET_CAMPUS_HIGH_ADJACENCY',					'COREXB_CAMPUS_HIGH_ADJACENCY'				),

			(	'COREX_SET_PLAYER_HAS_PRINTING',					'COREXB_PLAYER_HAS_PRINTING'				),

			(	'COREX_SET_CITY_HAS_SHIPYARD',						'COREXB_CITY_HAS_SHIPYARD'					),
	...
	/* BUILDING C */	
			...
			(	'COREX_SET_PLOT_HAS_COREXC_TIER1_CUL',				'COREXC_PLOT_HAS_COREXC_TIER1_CUL'			),
			(	'COREX_SET_PLOT_HAS_RESORT',						'COREXC_PLOT_HAS_RESORT'					),
			(	'COREX_SET_PLOT_HAS_COREXC_TIER1_CUL_WONDER',		'COREXC_PLOT_HAS_COREXC_TIER1_CUL'			),
			(	'COREX_SET_PLOT_HAS_COREXC_TIER1_CUL_WONDER',		'COREXC_PLOT_HAS_WONDER_ADJACENT'			),
			(	'COREX_SET_PLOT_HAS_RESORT_WONDER',					'COREXC_PLOT_HAS_WONDER_ADJACENT'			),
			(	'COREX_SET_PLOT_HAS_RESORT_WONDER',					'COREXC_PLOT_HAS_RESORT'					),
