...
--===========================================================================================================================================================================--
	...
	/* DISTRICT C */								                                                                                                                                                                                                                                                                                	    			    	         					                          
			...
			(	'BUILDING_COREXC_TIER1_GOL',		'LOC_BUILDING_COREXC_TIER1_GOL_NAME',				NULL,						'CIVIC_IDEOLOGY',				'350',			'-1',					'DISTRICT_COREEXPANSIONC', 		'LOC_BUILDING_COREXC_TIER1_GOL_DESCRIPTION',		'6',			'1',					'0',					'YIELD_GOLD',				'NO_ERA',				'ADVISOR_GENERIC'			),
				...
				(	'BUILDING_COREXC_TIER1_SCI_2',		'LOC_BUILDING_COREXC_TIER1_SCI_2_NAME',				NULL,						NULL,							'250',			'-1',					NULL, 							'LOC_BUILDING_COREXC_TIER1_SCI_2_DESCRIPTION',		'0',			'0',					'0',					NULL,						'NO_ERA',				'ADVISOR_TECHNOLOGY'		),
				(	'BUILDING_COREXC_TIER1_SCI_3',		'LOC_BUILDING_COREXC_TIER1_SCI_3_NAME',				NULL,						NULL,							'250',			'-1',					NULL, 							'LOC_BUILDING_COREXC_TIER1_SCI_3_DESCRIPTION',		'0',			'0',					'0',					NULL,						'NO_ERA',				'ADVISOR_TECHNOLOGY'		),
				...
				(	'BUILDING_COREXC_TIER1_CUL_2',		'LOC_BUILDING_COREXC_TIER1_CUL_2_NAME',				NULL,						NULL,							'250',			'-1',					NULL, 							'LOC_BUILDING_COREXC_TIER1_CUL_2_DESCRIPTION',		'0',			'0',					'0',					NULL,						'NO_ERA',				'ADVISOR_CULTURE'			),
				(	'BUILDING_COREXC_TIER1_CUL_3',		'LOC_BUILDING_COREXC_TIER1_CUL_3_NAME',				NULL,						NULL,							'250',			'-1',					NULL, 							'LOC_BUILDING_COREXC_TIER1_CUL_3_DESCRIPTION',		'0',			'0',					'0',					NULL,						'NO_ERA',				'ADVISOR_CULTURE'			),
				...
				(	'BUILDING_COREXC_TIER1_GOL_2',		'LOC_BUILDING_COREXC_TIER1_GOL_2_NAME',				NULL,						NULL,							'250',			'-1',					NULL, 							'LOC_BUILDING_COREXC_TIER1_GOL_2_DESCRIPTION',		'0',			'0',					'0',					NULL,						'NO_ERA',				'ADVISOR_GENERIC'			),			
				(	'BUILDING_COREXC_TIER1_GOL_3',		'LOC_BUILDING_COREXC_TIER1_GOL_3_NAME',				NULL,						NULL,							'250',			'-1',					NULL, 							'LOC_BUILDING_COREXC_TIER1_GOL_3_DESCRIPTION',		'0',			'0',					'0',					NULL,						'NO_ERA',				'ADVISOR_GENERIC'			),			
...
/* DEPRECATED
	 ...
	 */
			...
			(	'PROJECT_COREXC_TIER1_SCI_REASERCH',					'Amount',					'3'									),
...
--===========================================================================================================================================================================--		
		INSERT INTO ProjectCompletionModifiers
			...
			(	'PROJECT_COREX_IPO_2',				'PROJECT_COREXC_TIER1_SCI_REASERCH'					);
